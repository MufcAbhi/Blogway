...
<div style="width: 100%;">
        <!-- header -->
        <div class="row">
        <div class="header-bg navbar-fixed-top" style="overflow: hidden;">
            <div class="container">
                <div class="row">
            ...
            <div class="row-fluid">
                <div class="col-lg-4 sidewala" style="float: left; margin-top: 90px;height: 100%;">
                    <div class="verticalnav">
                        <ul>
                            <li><a href="myblogadmin.php" class="active">My Blogs</a></li>
                                            ...
                                            echo '<li>'.'<div class="blogwell">';
                                                ...
                                                echo '<div class="bakiko">'; 
                                                    ...
                                                    echo $datascomment['num'];
                                                        echo "<a href='commentadmin.php?id=$id'> View all</a>"."&nbsp"."|";
