            ...
            <div class="row-fluid">
                <div class="col-lg-4 sidewala" style="float: left; margin-top: 90px;height: 100%;">
                    <div class="verticalnav">
                        <ul>
                            <li><a href="myblog.php" class="active">My Blogs</a></li>
                    ...
                    <div class="verticalnav" style="margin-top:10px; margin-bottom: 10px;">
                            <div style="width: 100%;">
                                <div class="tm-blocks-container effect1">
                                    <div class="tm-block green-bg">
                                        <a href="imagegalleryuploadadmin.php" class="tm-block-link">Technology</a>
                                    </div>
                                    <div class="tm-block">
                                        <?php
                                            $ImageArray = array();
                            ...
                            <div class="tm-block">
                                    ...
                                    <div id="myCarousel"  class="myCarousel carousel slideCarousel" data-ride="carousel" data-interval="4500" >
                                        ...
                                        for($l=0;$l<count($ImageArray);$l++){
                                            // creating indicators - note that at least one must be set as active
                                            if($l==0){
                                                        echo ' <li data-target="#myCarousel" data-slide-to="'.$l.'" class="active"></li>';
                                                    }else{
                            ...
                            <div class="tm-block red-bg">
                                <a href="imagegalleryuploadadmin.php" class="tm-block-link">Nature</a>
                            </div>
                            <div class="tm-block yellow-bg">
                                <a href="imagegalleryuploadadmin.php" class="tm-block-link">Wildlife</a>
                            </div>
                            <div class="tm-block">
                                        <?php
                                            $ImageArray = array();
                            ...
                            <div class="tm-block">
                                    ...
                                    <div id="myCarousel"  class="myCarousel carousel slideCarousel" data-ride="carousel" data-interval="5500" >
                                        ...
                                        for($m=0;$m<count($ImageArray);$m++){
                                            // creating indicators - note that at least one must be set as active
                                            if($m==0){
                                                        echo ' <li data-target="#myCarousel" data-slide-to="'.$m.'" class="active"></li>';
                                                    }else{
                            ...
                            <div class="tm-block blue-bg">
                                <a href="imagegalleryuploadadmin.php" class="tm-block-link">Just Pics</a>
                            </div>
                            </div>
                        </div>
                    </div>
