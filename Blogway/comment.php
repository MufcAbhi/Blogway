...
<div style="width: 100%;height: 100%;">
    ...
    <div class="container" style="background-color: white; margin-top: 50px;">
        ...
        <a href="myblog.php"><span class="glyphicon glyphicon-circle-arrow-left"></span>
         Go back... </a>
    </div>
        ...
        <div class="span8">
            ...
            <div class="blog">
                <div class="blog-item well" style="margin-top: -40px;">
                    <h1 align="center">
                    <?php
                                ...
                                <div class="col-md-12">
                                    <form class="form" action="" method="POST" id="commentform">
                                        <div id="comment-name" class="form-row">
                                            <input type = "text" placeholder = "Name (required)" name = "dname" class="form-control" id = "name" required="required">
                                        </div>
                                        <div id="comment-email" class="form-row">
                                            <input type = "email" placeholder = "Email (will not be published) (required)" name = "demail" class="form-control" id = "email" required="required">
                                        </div>
