...
<div class="container-fluid">
                    ...
                    <div class="col-lg-9 templatemo-nav-container">
                        <nav class="templatemo-nav">
                            <ul>
                                ...
                                <li><a href="imagegalleryuploadadmin.php" class="active">My Photography</a></li>
    ...
    <div class="row-fluid" style="margin-top: 100px;">
        ...
        <a href="myblogadmin.php"> Go back... </a>
    </div>
    ...
    <h1>Technology</h1><br>
        <?php
            ...
            while($datas=mysql_fetch_array($result)){
                ...
                $id=$datas['ImageGalleryID'];
                echo '<div style="float: left;">';
                echo "<a href='$image'><img class='img-thumbnail' src='$image'></a>";
                echo '<div align="center" style="height:50px;">';
                echo "<a href='deletegalleryimgage.php?id=$id'>Delete Image?</a>";
                echo '</div>';
                echo '</div>';
            }
        ?>
    ...
    <h1>Nature</h1><br>
        <?php
            ...
            while($datas=mysql_fetch_array($result)){
                $image= $datas['PictureName'];
                $id=$datas['ImageGalleryID'];echo '<div style="float: left;">';
                echo "<a href='$image'><img class='img-thumbnail' src='$image'></a>";
                echo '<div align="center" style="height:50px;">';
                echo "<a href='deletegalleryimgage.php?id=$id'>Delete Image?</a>";
                echo '</div>';
    ...
    <h3 align="center"><span style="color: red"> Add new image? </h3>
    <div class="row-fluid">
    <form role="form" method="post" enctype="multipart/form-data" action="#" style="border: 3px solid; margin: 5px; padding: 5px;">
        ...
        <div class="form-group">
            <div>
                <button type="submit" name="submit" value="submit" class="btn btn-success">Upload Picture</button>
            </div>
        </div>
    </form>
    </div>
